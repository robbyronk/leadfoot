defmodule LeadfootWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LeadfootWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LeadfootWeb.Gettext, "errors", msg, opts)
    end
  end
