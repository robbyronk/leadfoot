...
#  end
  ...
  def sample() do
    %{
      ...
      steer: 0,
      surface_rumble: %{front: %{left: 0.0, right: 0.0}, rear: %{left: 0.0, right: 0.0}},
      suspension_travel: %{
      ...
      unknown2: <<0, 0, 0, 0>>,
      unknown3: <<0>>,
      velocity: %{x: -0.4708080291748047, y: -0.15454605221748352, z: 33.45265197753906},
      wheel_rotation: %{
        front: %{left: 102.3346939086914, right: 102.14707946777344},
        rear: %{left: 105.00837707519531, right: 104.98289489746094}
      },
      yaw_pitch_roll: %{x: 2.0288658142089844, y: -0.11731956154108047, z: -0.04284701123833656}
    }
  end
end
