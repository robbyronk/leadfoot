defmodule RaceControl.ReadFile do
  ...
  # car category: https://github.com/Ldalvik/ForzaTelemetryAndroidApp/blob/main/app/src/main/java/root/forza/telemetry/ForzaApi.java#L515
  ...
  def read_packets(<<
        ...
        rest::binary
      >>) do
    [parse_packet(packet) | read_packets(rest)]
  end
