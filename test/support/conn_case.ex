defmodule LeadfootWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use LeadfootWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Leadfoot.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Leadfoot.Accounts.generate_user_session_token(user)
